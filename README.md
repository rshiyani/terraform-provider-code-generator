...
| `getURL` | *`string`*<br/> (terraformer only) getURL is a URL used to get all resources from API. |
| `resource_allowed_empty_attributes` | *`list of strings`*<br/> (terraformer only) resource_allowed_empty_attributes is a list of attributes which is used to describe allowed empty attributes for the resource. |
